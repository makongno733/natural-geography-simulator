...
const PROJECTIONS = [
  ...
  { id: 'utm', name: 'UTM', en: 'UTM', cat: '圆柱', prop: '等角' },
  ...
  { id: 'lambert_cyl', name: '兰伯特等积圆柱', en: 'Lambert Cyl. Equal-Area', cat: '圆柱', prop: '等积' },
  ...
  { id: 'equal_earth', name: '等面积地球', en: 'Equal Earth', cat: '伪圆柱', prop: '等积' },
  ...
  { id: 'lambert_azimuthal', name: '兰伯特等积方位', en: 'Lambert Azimuthal Eq-Area', cat: '方位', prop: '等积' },
  ...
  function deform(projId, progress) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      pos.setXYZ(i,
        ...
        orig[i * 3 + 1] + (-R * 1.3 + py - orig[i * 3 + 1]) * progress,
        orig[i * 3 + 2] + (0 - orig[i * 3 + 2]) * progress,
      )
    }
