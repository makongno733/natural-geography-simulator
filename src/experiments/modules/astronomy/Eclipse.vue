...
.ec-canvas-wrap { flex: 1; min-height: 460px; background: #000011; position: relative; overflow: hidden; }
...
.ec-canvas-wrap canvas { width: 100%; height: 100%; display: block; position: absolute; top: 0; left: 0; }
