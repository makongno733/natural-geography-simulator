...
.ev-source { display: flex; flex-wrap: wrap; gap: 10px 16px; align-items: center; margin: 0 0 18px; padding: 10px 12px; background: rgba(158, 36, 38, 0.07); border-radius: 4px; font-size: 13px; color: var(--ink); }
...
.concept-tag { font-size: 12px; padding: 2px 8px; border-radius: 3px; background: rgba(158, 36, 38, 0.07); color: var(--red); }
