const t=[{title:"准备材料",content:"准备一个透明塑料瓶（带盖）、少量温水、一根火柴。实验在安全环境下进行，注意防火。",highlight:"温水提供水汽，火柴提供凝结核（烟尘颗粒）。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"引入水汽和凝结核",content:"向瓶中倒入少量温水，轻轻摇晃使瓶壁湿润。点燃火柴，吹灭后迅速将带烟的火柴头伸入瓶中让烟尘进入，拧紧瓶盖。",highlight:"烟尘颗粒是云滴形成的必要条件——作为凝结核，水汽在其表面聚集。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"加压——压缩升温",content:"用手用力挤压瓶身。瓶内气压增大，空气压缩后温度升高（绝热压缩），相对湿度降低，瓶中透明无云。",highlight:"绝热压缩：体积减小 → 温度升高 → 饱和水汽压升高 → 相对湿度下降。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"释压——膨胀降温，云形成",content:'快速松开手让瓶子回弹。空气绝热膨胀温度骤降，相对湿度超过 100%，水汽在烟尘颗粒上凝结成微小水滴——瓶中出现了可见的"云"！',highlight:"绝热膨胀是大气成云的核心机制。空气上升→气压降低→膨胀冷却→水汽凝结→云。干绝热递减率约 10°C/km。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"重复观察与总结",content:"反复挤压释放几次，观察云的反复出现和消失。挤压（加压升温）时云消失，释放（减压降温）时云重新形成。真实大气中湿空气上升冷却成云，干绝热递减率约 10°C/km，湿绝热递减率约 6°C/km。",highlight:"云滴直径约 10-20 μm，一滴雨滴含约 100 万个云滴。水在大气中平均停留时间约 9 天。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`}],e={name:"CloudBottle",steps:t};export{e as default};
