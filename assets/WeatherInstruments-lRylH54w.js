const t=[{title:"气球气压计",content:"将气球剪开，绷紧覆盖在广口瓶口，用橡皮筋扎紧。吸管一端粘在气球膜中央，另一端作指针。气压变化使气球膜变形，带动指针偏移。气压↑→膜凹陷→指针上翘；气压↓→膜凸起→指针下垂。",highlight:"气压变化引起密闭瓶内外压力差，使弹性膜变形。标准大气压 = 1013.25 hPa。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"乒乓球风速计",content:"将乒乓球用细线悬挂在量角器中心。风吹动乒乓球使细线偏离垂直方向。测量偏角 θ，风速 v 与 tanθ 成正比。偏角越大风速越大，可用已知风速校准。",highlight:"风对球的拖曳力与风速平方成正比。蒲福风级将风速分为 0-12 级。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"简易雨量计",content:"取直筒透明容器（如量筒），上方放置漏斗确保边缘水平，放在开阔处。降雨后读取收集水深。雨量 = 水体体积 / 漏斗口面积。1 mm 降雨量 = 每平方米 1 升水。",highlight:"标准雨量计口径 20 cm。降水强度：小雨 < 10 mm/h，暴雨 > 50 mm/h。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`},{title:"风向标",content:"在吸管一端剪出箭头形尾翼，另一端加配重（橡皮泥），中间用大头针作转轴，插在铅笔橡皮上。放在风中箭头指向风吹来的方向。风以来源方向命名（北风 = 从北向南吹）。",highlight:"风向用 16 方位或 0-360° 表示。气象站标准高度 10 m。",illustration:`<svg width="100%" height="auto" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
</svg>`}],e={name:"WeatherInstruments",steps:t};export{e as default};
